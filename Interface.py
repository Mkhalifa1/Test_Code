...
def new_cust():
    ...
    mobile_no = input('Enter the mobile number of customer: ')
...
# =============================================================================
#         
# The value of return in this case is None, 
# meaning no specific value is being returned. 
# It's simply used to terminate the function and continue with the rest of the program.
# 
# =============================================================================
